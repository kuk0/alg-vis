...
public abstract class VisPanel extends JPanel implements ChangeListener {
	...
	Buttons B; // gombikov (dolu)
	Commentary C; // komentara (vpravo)
	DataStructure D; // datovej struktury
	Screen S; // obrazovky v strede
	ILabel statusBar; // a status baru
	...
	int STEPS = 10;
	boolean pause = true, small = false;
