...
public class DynamicArray extends DataStructure implements ClickListener {
    ...
    public void draw(View v) {
        ...
        for (DynamicArrayCoin coin : coinsForArray) {
            coin.draw(v);
        }
        for (DynamicArrayCoin coin : newCoins) {
            coin.draw(v);
        }
        ...
        v.drawTextBubble(new IString("dynamicarray-copyText").getString(), -250,
            140, 75, 255, REL.LEFT);
        v.drawTextBubble(new IString("dynamicarray-allocateText").getString(),
            -250, 60, 75, 255, REL.LEFT);
    }
    ...
    public void storeState(Hashtable<Object, Object> state) {
        ...
        HashtableStoreSupport.store(state, hash + "coinsForArray",
            coinsForArray.clone());
        HashtableStoreSupport.store(state, hash + "coinsForCopy",
            coinsForCopy.clone());
        ...
        HashtableStoreSupport.store(state, hash + "newdelimiter2",
            newdelimiter2);
        HashtableStoreSupport.store(state, hash + "newdelimiter4",
            newdelimiter4);
        ...
        if (this.delimiter2 != null) {
            delimiter2.storeState(state);
        }
        if (this.delimiter4 != null) {
            delimiter4.storeState(state);
        }
        if (this.newdelimiter2 != null) {
            newdelimiter2.storeState(state);
        }
        if (this.newdelimiter4 != null) {
            newdelimiter4.storeState(state);
        }
    ...
    public void restoreState(Hashtable<?, ?> state) {
        ...
        if (array != null) {
            this.array = (Array<ArrayNode>) HashtableStoreSupport
                .restore(array);
        }
        if (this.array != null) {
        ...
        if (coinsForCopy != null) {
            this.coinsForCopy = (ArrayList<DynamicArrayCoin>) HashtableStoreSupport
                .restore(coinsForCopy);
        }
        for (DynamicArrayCoin coin : this.coinsForCopy) {
            coin.restoreState(state);
        }

        final Object coinsForArray = state.get(hash + "coinsForArray");
        if (coinsForArray != null) {
            this.coinsForArray = (ArrayList<DynamicArrayCoin>) HashtableStoreSupport
                .restore(coinsForArray);
        }
        for (DynamicArrayCoin coin : this.coinsForArray) {
            coin.restoreState(state);
        }

        final Object newCoins = state.get(hash + "newCoins");
        if (newCoins != null) {
            this.newCoins = (ArrayList<DynamicArrayCoin>) HashtableStoreSupport
                .restore(newCoins);
        }
        for (DynamicArrayCoin coin : this.newCoins) {
            coin.restoreState(state);
        }

        final Object delimiter2 = state.get(hash + "delimiter2");
        if (delimiter2 != null) {
            this.delimiter2 = (DynamicArrayDelimiter) HashtableStoreSupport
                .restore(delimiter2);
        }
        if (this.delimiter2 != null) {
            this.delimiter2.restoreState(state);
        }

        final Object delimiter4 = state.get(hash + "delimiter4");
        if (delimiter4 != null) {
            this.delimiter4 = (DynamicArrayDelimiter) HashtableStoreSupport
                .restore(delimiter4);
        }
        if (this.delimiter4 != null) {
            this.delimiter4.restoreState(state);
        }

        final Object newdelimiter2 = state.get(hash + "newdelimiter2");
        if (newdelimiter2 != null) {
            this.newdelimiter2 = (DynamicArrayDelimiter) HashtableStoreSupport
                .restore(newdelimiter2);
        }
        if (this.newdelimiter2 != null) {
            this.newdelimiter2.restoreState(state);
        }

        final Object newdelimiter4 = state.get(hash + "newdelimiter4");
        if (newdelimiter4 != null) {
            this.newdelimiter4 = (DynamicArrayDelimiter) HashtableStoreSupport
                .restore(newdelimiter4);
        }
        if (this.newdelimiter4 != null) {
            this.newdelimiter4.restoreState(state);
        }
        ...
        if (this.invisible != null) {
            this.invisible.restoreState(state);
        }
    }
}
