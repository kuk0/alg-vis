...
public class DynamicArrayInsert extends DynamicArrayAlg {
    ...
    public void runAlgorithm() {
        ...
        if (D.size > D.capacity / 2) {
            ...
            D.newCoins.get(3).changeRelative(D.array.get(D.size - 1));
            D.newCoins.get(3).moveTo(0, D.coinsDist);
            D.newCoins.get(2).changeRelative(D.array.get(D.size - 1));
            D.newCoins.get(2).moveTo(0, -D.coinsDist);
            ...
            for (DynamicArrayCoin coin : D.newCoins) {
                coin.setColor(NodeColor.RED);
            }
